...
exports.updateTask = exports.saveTask = exports.getTasks = exports.getTask = exports.getCount = exports.deleteTasks = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return connection.execute('SELECT * FROM tareas');
        case 5:
...
var getTask = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var connection, _yield$connection$exe3, _yield$connection$exe4, rows;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 5;
          return connection.execute('SELECT * FROM tareas WHERE id = ?', [req.params.id]);
        case 5:
...
var getCount = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          _context3.next = 5;
          return connection.execute('SELECT COUNT(*) FROM tareas');
        case 5:
  ...
  return function getCount(_x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 5;
          return connection.query('DELETE FROM tareas WHERE id = ?', [req.params.id]);
        case 5:
          res.sendStatus(204);
        case 6:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return connection.query("UPDATE tareas SET ? WHERE id = ?", [req.body, req.params.id]);
        case 5:
...
var saveTask = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          _context6.next = 5;
          return connection.query("INSERT INTO tareas(title, description) VALUES (?, ?)", [req.body.title, req.body.description]);
        case 5:
  ...
  return function saveTask(_x11, _x12) {
